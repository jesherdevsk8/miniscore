  ...
  module V1
    class ClassificationController < ApiV1ApplicationController
      ...
      def show
        ...
        players = team.get_players(year).sort_by { |hash| [ -hash[:statistics][:performance_percentage], hash[:name] ] }
        ...
        render json: { data: players, top_scorers: top_scorers, least_conceded_goalkeepers: least_conceded_goalkeepers }
      end
